                        ...
                        success: function(response) {
                            if (response.status === 200) {
                                ...
                                response.submittedExercises.forEach(function(submittedExercise) {
                                    submittedExercisesHtml += '<li>' + submittedExercise.user.username + ' - ' + submittedExercise.user.name + ' <button class="btn btn-info btn-sm viewBtn" data-file="' + submittedExercise.file + '">Xem</button> <button class="btn btn-primary btn-sm downloadBtn" data-file="' + submittedExercise.file + '">Tải xuống</button></li>';
                                });
